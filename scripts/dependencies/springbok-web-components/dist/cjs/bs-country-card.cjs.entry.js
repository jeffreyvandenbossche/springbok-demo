...
const BsCountryCard = class {
  ...
  get parsedFlag() {
    return parseIfString.parseIfString(this.flag);
  }
  get parsedTitle() {
    return parseIfString.parseIfString(this.countryTitle);
  }
  get parsedBrands() {
    return parseIfString.parseIfString(this.brands);
  }
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "country-card" }, index.h("div", { class: "flex align-center" }, index.h("div", { class: "flag" }, index.h("bs-image", Object.assign({}, this.parsedFlag))), index.h("div", { class: "title" }, index.h("bs-title", Object.assign({}, this.parsedTitle)))), index.h("div", { class: "flex" }, this.parsedBrands.map((brand) => (index.h("bs-click-action", { class: "brand", href: brand.href }, brand.label)))))));
  }
};
__decorate([
  memoize.Memoize('flag')
], BsCountryCard.prototype, "parsedFlag", null);
__decorate([
  memoize.Memoize('countryTitle')
], BsCountryCard.prototype, "parsedTitle", null);
__decorate([
  memoize.Memoize('brands')
], BsCountryCard.prototype, "parsedBrands", null);
BsCountryCard.style = countryCardCss;

exports.bs_country_card = BsCountryCard;

//# sourceMappingURL=bs-country-card.cjs.entry.js.map