...
const BsYoutubeVideo = class {
  constructor(hostRef) {
    ...
    this.bsYoutubeControllerUpdate = index.createEvent(this, "bsYoutubeControllerUpdate", 7);
    /** methods */
    ...
    this.onPlayerStateChange = (e) => {
      ...
      if (this.playerState === youtubeVideo_types.PlayerState.PLAYING) {
        this.progressBarInterval = setInterval(this.calculateTime, 100);
      }
      else if (this.playerState === youtubeVideo_types.PlayerState.UNSTARTED) {
        this.player.playVideo();
      }
      else if (this.playerState === youtubeVideo_types.PlayerState.ENDED) {
        this.updateYoutubeController();
    ...
    this.isIosOrSafari = () => {
      ...
      const match = !isEmpty.isEmpty(userAgent.match(/(iPad|iPhone|iPod)/g)) || safariAgent;
  ...
  render() {
    if (this.inline) {
      return (index.h("div", { slot: "media", class: "youtube-video" }, index.h("div", { ref: (el) => {
          this.videoElementRef = el;
        }, class: "youtube-embed", tabIndex: -1 })));
    }
    return (index.h(index.Host, null, index.h("bs-dark-overlay", { class: "media", ref: (el) => {
        this.overlayRef = el;
      } }, index.h("div", { slot: "media", class: "youtube-video" }, index.h("div", { ref: (el) => {
        this.videoElementRef = el;
      }, class: "youtube-embed", tabIndex: -1 })), index.h("div", { slot: "controller", class: "media-control" }, index.h("bs-youtube-control", { mute: this.mute, videoId: this.videoId })))));
  }
...
exports.bs_youtube_video = BsYoutubeVideo;

//# sourceMappingURL=bs-youtube-video.cjs.entry.js.map