...
const BsDotNavigation = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: this.slow ? 'is-slow' : '' }, index.h("span", { class: "dot-nav" }, dots.map((index$1) => index$1 === this.index ? (index.h("progress", { class: "dot dot--active", max: "100", value: this.progress })) : (index.h("progress", { class: "dot", max: "100", value: "0" }))))));
  }
  static get watchers() { return {
    "index": ["handleIndexChange"]
  }; }
};
BsDotNavigation.style = dotNavigationCss;

exports.bs_dot_navigation = BsDotNavigation;

//# sourceMappingURL=bs-dot-navigation.cjs.entry.js.map