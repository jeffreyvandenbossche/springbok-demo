...
const experienceZone_types = require('./experience-zone.types-fae744f1.js');
...
const BsExperienceZoneScreen$1 = class {
  ...
  get parsedComponents() {
    if (this.components !== undefined) {
      return parseIfString.parseIfString(this.components);
    }
    return [];
  }
  /** Watchers */
  handleActiveChange(isActive) {
    if (this.layout === experienceZone_types.ExperienceZoneLayout.Video) {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "experience-zone-screen" }, index.h("div", { class: `screen screen--${this.layout}` }, isEmpty.isEmpty(this.parsedComponents)
      ? Array.from(Array(3)).map((_value, i) => (index.h("div", { class: `screen-item` }, index.h("slot", { name: `item-${i}` }))))
      : this.parsedComponents.map((component) => {
        const Tag = component.tag;
        return (index.h("div", { class: `screen-item ${Tag}-screen` }, index.h(Tag, Object.assign({}, component.data))));
      })), this.disclaimer && (index.h("bs-container", { contained: true }, index.h("bs-text", { text: this.disclaimer, size: text_types.TextSize.Small, color: text_types.TextColor.Default }))))));
  }
...
const BsExperienceZoneScreen = class {
  ...
  get parsedStoryData() {
    return parseIfString.parseIfString(this.storyData);
  }
  /** Watchers */
  handleActiveChange(isActive) {
    if (isActive) {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "experience-zone-story" }, index.h("bs-dark-overlay", { ref: (el) => {
        this.overlayRef = el;
        ...
        experienceZone_types.ExperienceZoneLayout.Video &&
        breakpoints.compareBreakpoint('max', breakpoints.Breakpoint.md)) ||
        breakpoints.compareBreakpoint('min', breakpoints.Breakpoint.md)
        ? this.parsedStoryData.storyLogo
        : '' }, index.h("bs-experience-zone-screen", { ref: (el) => {
      ...
      experienceZone_types.ExperienceZoneLayout.Video && (index.h("bs-container", { slot: "controller", contained: true }, index.h("div", { class: "screen-footer" }, index.h("bs-youtube-control", { videoId: this.parsedStoryData.screens[this.activeIndex].components[0]
        .data.videoId }))))))));
  }
  static get watchers() { return {
    "active": ["handleActiveChange"]
...
__decorate([
  memoize.Memoize('storyData')
], BsExperienceZoneScreen.prototype, "parsedStoryData", null);
BsExperienceZoneScreen.style = experienceZoneStoryCss;

exports.bs_experience_zone_screen = BsExperienceZoneScreen$1;
exports.bs_experience_zone_story = BsExperienceZoneScreen;

//# sourceMappingURL=bs-experience-zone-screen_2.cjs.entry.js.map