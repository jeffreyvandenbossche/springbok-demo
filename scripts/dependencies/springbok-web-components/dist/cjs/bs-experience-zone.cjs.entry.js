...
const BsExperienceZoneTeaser = class {
  ...
  get parsedTeaserTitle() {
    return parseIfString.parseIfString(this.teaserTitle);
  }
  /** listeners */
  handleScreenResized() {
    this.throttleMethod();
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "teaser-head" }, index.h("bs-title", { text: this.parsedTeaserTitle.text, tag: this.parsedTeaserTitle.tag, size: this.parsedTeaserTitle.size, variant: this.parsedTeaserTitle.variant, color: this.parsedTeaserTitle.color }), this.slides && (index.h("div", { class: "teaser-navigation" }, index.h("bs-click-action", { name: "previous", onBsClickAction: this.onPreviousSlide, tagClass: "navigation-button", ariaLabelText: "backward" }, index.h("bs-icon", { name: icon_types.IconName.ArrowBackward })), index.h("bs-click-action", { name: "next", onBsClickAction: this.onNextSlide, tagClass: "navigation-button", ariaLabelText: "forward" }, index.h("bs-icon", { name: icon_types.IconName.ArrowForward }))))), index.h("div", { class: "teaser-slider", ref: (el) => {
        this.teaserSliderRef = el;
      } }, this.parsedExperienceZoneData.stories.map((story, index$1) => (index.h("bs-click-action", { name: "open-experience-zone-modal", class: "grow", tagClass: "grow click-action", value: { activeIndex: index$1, experienceZoneData: this.experienceZoneData } }, index.h("bs-experience-zone-card", { class: "teaser-card", singular: this.parsedExperienceZoneData.stories.length === 1, cardTitle: story.storyTitle, cardImage: story.storyImage, video: story.screens[0].layout === experienceZone_types.ExperienceZoneLayout.Video })))))));
  }
};
__decorate([
...
__decorate([
  memoize.Memoize('teaserTitle')
], BsExperienceZoneTeaser.prototype, "parsedTeaserTitle", null);
BsExperienceZoneTeaser.style = experienceZoneCss;

exports.bs_experience_zone = BsExperienceZoneTeaser;

//# sourceMappingURL=bs-experience-zone.cjs.entry.js.map