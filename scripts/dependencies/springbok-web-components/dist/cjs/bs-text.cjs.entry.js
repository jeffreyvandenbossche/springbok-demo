...
const Paragraph = class {
  ...
  render() {
    ...
    const fontSize = Object.values(text_types.TextSize).includes(this.size)
      ? `font-${this.size}`
      : `font-inherit`;
    const textColor = Object.values(text_types.TextColor).includes(this.textColor)
      ? `text-color-${this.textColor}`
      : '';
    return (index.h(index.Host, null, index.h("div", { class: `text ${fontSize} ${textColor}`, innerHTML: this.text })));
  }
};
Paragraph.style = textCss;

exports.bs_text = Paragraph;

//# sourceMappingURL=bs-text.cjs.entry.js.map