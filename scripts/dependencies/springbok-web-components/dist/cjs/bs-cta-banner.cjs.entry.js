...
const BsCTABanner = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.bannerTitle = undefined;
    this.subtitle = undefined;
    this.button = undefined;
    this.variant = button_types.ButtonVariant.Primary;
    this.filled = false;
  }
  get parsedBannerTitle() {
    return parseIfString.parseIfString(this.bannerTitle);
  }
  get parsedButton() {
    return parseIfString.parseIfString(this.button);
  }
  render() {
    return (index.h(index.Host, { class: `is-${this.variant}-variant ${this.filled ? 'is-filled' : ''}` }, index.h("div", { class: "cta-banner" }, index.h("div", { class: "text-wrapper" }, index.h("bs-title", Object.assign({ class: "title" }, this.parsedBannerTitle)), this.subtitle && index.h("bs-text", { class: "sub", text: this.subtitle, size: text_types.TextSize.Default })), index.h("bs-button", Object.assign({}, this.parsedButton, { isFullWidth: this.variant === button_types.ButtonVariant.Secondary || breakpoints.compareBreakpoint('max', breakpoints.Breakpoint.md), variant: this.variant, ghost: true })))));
  }
};
__decorate([
  memoize.Memoize('bannerTitle')
], BsCTABanner.prototype, "parsedBannerTitle", null);
__decorate([
  memoize.Memoize('button')
], BsCTABanner.prototype, "parsedButton", null);
BsCTABanner.style = ctaBannerCss;

exports.bs_cta_banner = BsCTABanner;

//# sourceMappingURL=bs-cta-banner.cjs.entry.js.map