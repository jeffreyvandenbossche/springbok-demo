...
const BsFormContainer = class {
   ...
   */
  componentDidLoad() {
    this.allFields = deepQuerySelectorAll.deepQuerySelectorAll('bs-form-field', this.hostElement);
  }
  /**
   * Render
   */
  render() {
    return (index.h(index.Host, null, index.h("script", { src: `https://www.google.com/recaptcha/api.js?render=${this.recaptchaSiteKey}` }), index.h("form", { class: "form-container", action: this.action, method: "dialog" }, index.h("slot", null), this.formHasErrors && index.h("p", { class: "form-error" }, this.invalidFormMessage, "\u00A0"), this.submitHasFailed && index.h("p", { class: "form-error" }, this.submitErrorMessage, "\u00A0"))));
  }
  get hostElement() { return index.getElement(this); }
};
BsFormContainer.style = formContainerCss;

exports.bs_form_container = BsFormContainer;

//# sourceMappingURL=bs-form-container.cjs.entry.js.map