...
const BsVideoCard = class {
  ...
  render() {
    return (index.h(index.Host, { class: `${this.parsedImage.cover ? 'is-background' : ''} ${this.autoplay ? 'is-autoplayed' : ''}` }, this.inline && this.active ? (index.h("div", { class: "inline-video" }, index.h("bs-youtube-video", { videoId: this.videoId, mute: this.mute, inline: true }))) : (index.h("div", { class: "video-card" }, index.h("bs-click-action", { tagClass: "button", name: this.inline ? 'open-youtube-inline' : 'open-youtube-modal', value: { videoId: this.videoId, mute: this.mute }, onBsClickAction: this.inline && this.handlePlayVideo }, index.h("bs-image", Object.assign({ class: "youtube-thumbnail" }, this.parsedImage, { caption: "" })), index.h("bs-icon", { class: "youtube-thumbnail-button", name: icon_types.IconName.Play }))))));
  }
};
__decorate([
...
exports.bs_video_card = BsVideoCard;

//# sourceMappingURL=bs-video-card.cjs.entry.js.map