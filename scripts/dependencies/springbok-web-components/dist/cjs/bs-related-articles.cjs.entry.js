...
const BsRelatedArticlesCard = class {
  constructor(hostRef) {
  ...
  get parsedArticlesData() {
    return parseIfString.parseIfString(this.articlesData);
  }
  get parsedRelatedArticlesTitle() {
    return parseIfString.parseIfString(this.relatedArticlesTitle);
  }
  render() {
    return (index.h(index.Host, null, index.h("bs-title", { text: this.parsedRelatedArticlesTitle.text, tag: this.parsedRelatedArticlesTitle.tag, size: this.parsedRelatedArticlesTitle.size, variant: this.parsedRelatedArticlesTitle.variant }), index.h("div", { class: "related-articles" }, this.parsedArticlesData.map((article) => (index.h("bs-article-card", { articleTitle: article.articleTitle, articleCta: article.articleCta, articleHref: article.articleHref, articleImage: article.articleImage }))))));
  }
};
__decorate([
  memoize.Memoize('articlesData')
], BsRelatedArticlesCard.prototype, "parsedArticlesData", null);
__decorate([
  memoize.Memoize('relatedArticlesTitle')
], BsRelatedArticlesCard.prototype, "parsedRelatedArticlesTitle", null);
BsRelatedArticlesCard.style = relatedArticlesCss;

exports.bs_related_articles = BsRelatedArticlesCard;

//# sourceMappingURL=bs-related-articles.cjs.entry.js.map