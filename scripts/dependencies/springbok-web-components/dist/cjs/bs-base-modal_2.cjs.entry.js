...
const deepQuerySelectorAll = require('./deepQuerySelectorAll-843c6074.js');
...
function getActiveElement(root = document) {
  ...
  if (isEmpty.isEmpty(activeEl)) {
    return null;
  }
  if (!isEmpty.isEmpty(activeEl.shadowRoot)) {
...
const BsBaseModal = class {
  constructor(hostRef) {
    ...
    this.bsModalIsClosing = index.createEvent(this, "bsModalIsClosing", 7);
    this.bsModalIsClosed = index.createEvent(this, "bsModalIsClosed", 7);
    this.bsNextSlideAction = index.createEvent(this, "bsNextSlideAction", 7);
    this.bsPreviousSlideAction = index.createEvent(this, "bsPreviousSlideAction", 7);
  ...
  async handleFocus() {
    var _a;
    // focus trap
    this.focusableElements = deepQuerySelectorAll.deepQuerySelectorAll('button:not([disabled]), a:not([disabled]), input:not([disabled]), [tabindex]:not([tabindex="-1"]', this.el.firstElementChild);
  ...
  render() {
    return (index.h(index.Host, { class: `${!isEmpty.isEmpty(this.transitionType) ? `has-${this.transitionType}-transition` : ''}` }, index.h("slot", null)));
  }
...
const BsContainer = class {
  ...
  render() {
    return (index.h(index.Host, { class: `bs-container ${this.mobileFullWidth ? 'is-mobile-full-width' : ''} ${this.contained ? 'is-contained' : ''}` }, index.h("slot", null)));
  }
};
BsContainer.style = containerCss;

exports.bs_base_modal = BsBaseModal;
exports.bs_container = BsContainer;

//# sourceMappingURL=bs-base-modal_2.cjs.entry.js.map