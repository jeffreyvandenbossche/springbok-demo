...
const BsFormRadioButton = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("fieldset", { class: "form-fieldset" }, index.h("legend", { class: "form-legend" }, this.label, this.required && !isEmpty.isEmpty(this.label) ? index.h("span", { "aria-hidden": "true" }, "\u00A0*") : ''), index.h("bs-form-field", { ref: (el) => {
      ...
      }, value: this.value, name: this.name, invalid: this.invalid, required: this.required, requiredMessage: this.requiredMessage, label: this.label, border: false }, this.parsedOptions.map((radio, index$1) => (index.h("div", { slot: "form-element", class: "form-group" }, index.h("input", { class: "form-input", id: `radio-${index$1}`, type: "radio", name: this.name, value: radio.value, disabled: radio.disabled, checked: radio.selected, onChange: this.handleOnChange }), index.h("label", { class: "form-label", htmlFor: `radio-${index$1}`, title: radio.text }, radio.text))))))));
  }
};
__decorate([
...
exports.bs_form_radio_button = BsFormRadioButton;

//# sourceMappingURL=bs-form-radio-button.cjs.entry.js.map