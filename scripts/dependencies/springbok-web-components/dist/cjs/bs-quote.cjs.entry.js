...
const BsQuote = class {
  ...
  get parsedAuthorImage() {
    return parseIfString.parseIfString(this.authorImage);
  }
  render() {
    const schema = {
    ...
    return (index.h(index.Host, null, index.h("blockquote", { class: "blockquote", cite: this.source }, index.h("p", { class: "quote" }, "\"", this.text, "\""), index.h("div", { class: "info" }, index.h("div", { class: "author-image" }, index.h("bs-image", Object.assign({ class: "image" }, this.parsedAuthorImage, { cover: true }))), index.h("dl", { class: "author-info" }, index.h("dt", null, this.authorName), index.h("dd", null, this.authorPosition)))), index.h("script", { type: "application/ld+json" }, JSON.stringify(schema))));
  }
};
__decorate([
  memoize.Memoize('authorImage')
], BsQuote.prototype, "parsedAuthorImage", null);
BsQuote.style = quoteCss;

exports.bs_quote = BsQuote;

//# sourceMappingURL=bs-quote.cjs.entry.js.map