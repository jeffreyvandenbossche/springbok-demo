...
const BsBlogHeader = class {
  ...
  get parsedTitle() {
    return parseIfString.parseIfString(this.head);
  }
  render() {
    return (index.h(index.Host, null, index.h("header", { class: "blog-header" }, index.h("bs-title", { variant: this.parsedTitle.variant, color: this.parsedTitle.color, tag: this.parsedTitle.tag, class: "blog-header-title", text: this.parsedTitle.text }), index.h("bs-image", { src: this.parsedImage.src, srcset: this.parsedImage.srcset, width: this.parsedImage.width, height: this.parsedImage.height, "image-sizes": this.parsedImage.imageSizes, "alt-text": this.parsedImage.altText, itemprop: this.parsedImage.itemprop, cover: this.parsedImage.cover }), index.h("bs-logo-bar", { logo: this.parsedLogo }))));
  }
};
__decorate([
...
__decorate([
  memoize.Memoize('head')
], BsBlogHeader.prototype, "parsedTitle", null);
BsBlogHeader.style = blogHeaderCss;

exports.bs_blog_header = BsBlogHeader;

//# sourceMappingURL=bs-blog-header.cjs.entry.js.map