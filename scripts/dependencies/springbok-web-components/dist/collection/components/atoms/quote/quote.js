...
export class BsQuote {
  ...
  render() {
    ...
    return (h(Host, null, h("blockquote", { class: "blockquote", cite: this.source }, h("p", { class: "quote" }, "\"", this.text, "\""), h("div", { class: "info" }, h("div", { class: "author-image" }, h("bs-image", Object.assign({ class: "image" }, this.parsedAuthorImage, { cover: true }))), h("dl", { class: "author-info" }, h("dt", null, this.authorName), h("dd", null, this.authorPosition)))), h("script", { type: "application/ld+json" }, JSON.stringify(schema))));
  }
  static get is() { return "bs-quote"; }
